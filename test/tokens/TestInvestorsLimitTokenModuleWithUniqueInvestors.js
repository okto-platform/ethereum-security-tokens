...
contract('InvestorsLimitTokenModuleFactory', async(accounts) => {
    ...
    let investorIdBucket = web3.utils.fromUtf8('investorId');
    let investorId1 = web3.utils.fromUtf8('investor1');
    let investorId2 = web3.utils.fromUtf8('investor2');
    let investorId3 = web3.utils.fromUtf8('investor3');
